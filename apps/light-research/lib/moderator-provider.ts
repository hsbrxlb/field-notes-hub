...
export type ProviderTurnInput = {
  ...
  selectedMove?: { action: string; anchorId: string; fieldId: string | null; kind: string; language: string };
...
When the participant still cannot answer after a focused probe, do not ask the same question again in different words. Defer the gap and continue.
